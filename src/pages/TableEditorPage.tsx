...
export function TableEditorPage(): JSX.Element {
  ...
  return (
    <div className="container mx-auto py-8">
      <h1 className="text-2xl font-bold mb-6">{isEditing ? 'Edit Table' : 'Create New Table'}</h1>
      ...
      <div className="flex justify-end gap-2 mt-8">
        ...
        <Button onClick={handleSubmit}>{isEditing ? 'Save Changes' : 'Create Table'}</Button>
      </div>
    </div>
  );
}
